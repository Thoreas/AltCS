...
function talents(e, rebuildMenu = false) {
	...
	var talentConstellations = {
		"Alertness": { "minimumLevel": "1", "note": "+2 step bonus on initiative checks." },
		"Closer": { "minimumLevel": "1", "note": "+1 step bonus on Coercion and Influence checks when interacting with someone untrained in those skills." },
		"Commander": { "minimumLevel": "1", "note": "+1 step bonus on Coercion and Influence checks during combat." },
		"Commando": { "minimumLevel": "1", "note": "+1 step bonus to attack and skill check agains enemies who are unaware of you." },
		"Dirty Fighting": { "minimumLevel": "1", "note": "+3 damage when you successfully attack a distracted or surprised target." },
		"Drone Expert": { "minimumLevel": "1", "note": "issuing commands to a drone is a 2-impulse action." },
		"Elusive": { "minimumLevel": "1", "note": "ranged attacks against you from medium range (20m) or longer have an additional -1 step penalty." },
		"Gearhead": { "minimumLevel": "1", "note": "+1 step bonus on any technical skill check maintain or repair a machine, vehicle, ship or installation you've worked on before." },
		"Gunner": { "minimumLevel": "1", "note": "using the aim action modifier with a heavy weapon does not add a 1-impulse delay to the next action. Using the full auto action modifier with a heavy weapon adds a 1-impulse delay to the next action (instead of 2-impulse)." },
		"Gunslinger": { "minimumLevel": "1", "note": "draw one or more pistols as a free action when you attack with a pistol." },
		"Inventor": { "minimumLevel": "1", "note": "can choose 1 item from a Tech Era higher than the campaign's; item has 50% chance of being broken at the end of the scene if used by anyone else." },
		"Martial Arts, Grappling": { "minimumLevel": "1", "note": "+1 step bonus on Hand to Hand checks made to start a grapple." },
		"Martial Arts, Striking": { "minimumLevel": "1", "note": "unarmed damage is 1d6+0/4 P. Unarmed strike is a 2-impulse action." },
		"Medic": { "minimumLevel": "1", "note": "+1 step bonus on Medicine checks during combat." },
		"Melee Expert": { "minimumLevel": "1", "note": "+1 step attack bonus when using charge action modifier to attack with a melee weapon." },
		"Rugged": { "minimumLevel": "1", "note": "gain bonus wound boxes on graze and light wound rows." },
		"Sniper": { "minimumLevel": "1", "note": "aiming with a rifle has +2 step bonus (instead of +1 step bonus)." },
		"Spy": { "minimumLevel": "1", "note": "have a false identity (legend). True identity revealed only under rigorous background checks (usually require several days). Have Average-level contact who believes in your legend. Can \"burn\ˇ current false identity and create a new one in 10 days." },
		"Trooper": { "minimumLevel": "1", "note": "can use charge action modifier with ranged weapons, having a -1 step penalty to range attacks while charging." },
		"Artificial Systems": { "minimumLevel": "1", "restrictedToSpecies": "Android", "note": "Disengage Safeties is a 1-impulse action." },
